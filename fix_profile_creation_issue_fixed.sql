-- Fix Profile Creation Duplicate Key Issue (FIXED VERSION)
...
BEGIN
  ...
  RAISE NOTICE 'Cleaned up % orphaned auth users', row_count;
  ...
  GET DIAGNOSTICS row_count = ROW_COUNT;
  RAISE NOTICE 'Updated % profiles with organization_id', row_count;
