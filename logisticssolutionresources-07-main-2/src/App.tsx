                    ...
                    <Route path="/*" element={
                      <AppLayout>
                        <Routes>
                          ...
                          {/* New routes */}
                          <Route path="/tire-management" element={<TireManagement />} />
                          <Route path="/schedule" element={<Schedule />} />
                          <Route path="/school-routes" element={<SchoolRoutes />} />
                          <Route path="/rail-replacement" element={<RailReplacement />} />
                          ...
                          <Route path="/infringement-management" element={<InfringementManagement />} />
                          <Route path="/tachograph-manager" element={<TachographManager />} />
                          <Route path="/inspections" element={<Inspections />} />
                          <Route path="/vehicle-check-questions" element={<VehicleCheckQuestions />} />
