...
const handler = async (req: Request): Promise<Response> => {
  ...
  try {
    ...
    const adminEmailResponse = await resend.emails.send({
      from: `Transentrix Demo <${fromEmail}>`,
      to: [adminEmail],
      ...
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 40px 20px; text-align: center;">
            ...
            <p style="color: #bfdbfe; margin: 10px 0 0 0;">Transentrix - Transport Management System</p>
          </div>
    ...
    const userEmailResponse = await resend.emails.send({
      from: `Transentrix Team <${fromEmail}>`,
      to: [email],
      subject: "Thank you for requesting a demo - Transentrix",
      html: `
        <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
          <div style="background: linear-gradient(135deg, #1e40af 0%, #3b82f6 100%); padding: 40px 20px; text-align: center;">
          ...
          <div style="padding: 40px 20px; background: #f8fafc;">
            ...
            <p style="color: #475569; font-size: 16px; line-height: 1.6;">
              Thank you for your interest in Transentrix! We've received your demo request and our team will be in touch within 24 hours to schedule your personalized demonstration.
            </p>
