-- =====================================================
-- COMPREHENSIVE BACKEND SECURITY & PARTS INTEGRATION (FIXED)
-- =====================================================
...
-- 6. CREATE TRIGGERS (PROPER SYNTAX)
DO $$
BEGIN
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'generate_movement_number_trigger') THEN
    ...
    IF NOT EXISTS (SELECT 1 FROM pg_trigger WHERE tgname = 'update_part_quantity_trigger') THEN
