...
BEGIN
    ...
    IF org_id IS NOT NULL THEN
        -- Create sample drivers (only if they don't already exist)
        IF NOT EXISTS (SELECT 1 FROM public.profiles WHERE email = 'john.smith@lsr-logistics.com') THEN
        ...
        ELSE
            RAISE NOTICE 'Sample drivers already exist, skipping creation.';
        END IF;
    ELSE
