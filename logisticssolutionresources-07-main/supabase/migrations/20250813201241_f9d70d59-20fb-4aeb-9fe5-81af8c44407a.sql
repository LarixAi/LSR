-- Completely remove the security trigger temporarily
DROP TRIGGER IF EXISTS prevent_privilege_change ON public.profiles;

-- Update existing profiles that have test-like status to proper status
...
-- Update the handle_new_user function to create proper user profiles
...
BEGIN
    ...
    INSERT INTO public.profiles (
        ...
        'active',  -- All new users get active status
