...
INSERT INTO time_entries (driver_id, date, clock_in_time, total_hours, driving_hours, organization_id)
SELECT 
  id as driver_id,
  CURRENT_DATE,
  '08:00:00'::time,
...
WHERE role = 'driver' 
  ...
  AND NOT EXISTS (
    ...
    WHERE te.driver_id = profiles.id AND te.date = CURRENT_DATE
  );
