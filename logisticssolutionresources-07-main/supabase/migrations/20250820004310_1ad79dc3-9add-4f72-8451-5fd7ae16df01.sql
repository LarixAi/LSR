...
-- Restrict to authorized parents only for viewing
...
-- Allow drivers to manage pickup records
...
-- Allow admins to manage all pickup records in their organization
...
-- Apply audit logging to child-related tables (only for INSERT/UPDATE/DELETE)
