-- =====================================================
-- ADD SAMPLE DATA TO NATIONAL BUS GROUP (COMPLETE)
-- =====================================================
-- This script will add sample vehicles, work orders, and parts to the National Bus Group organization
-- Using the correct status values: 'reported', 'investigating', 'repairing', 'resolved', 'closed'
