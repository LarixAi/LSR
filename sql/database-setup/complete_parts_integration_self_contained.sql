-- =====================================================
-- COMPLETE PARTS & SUPPLIES INTEGRATION (SELF-CONTAINED)
-- =====================================================
-- This script creates the complete parts and supplies integration
-- Creates ALL tables from scratch including organizations table
-- NO external dependencies - completely self-contained

-- 1. CREATE ORGANIZATIONS TABLE (SELF-CONTAINED)
...
-- 2. CREATE PARTS INVENTORY TABLE (SELF-CONTAINED)
...
-- 3. CREATE PARTS REQUESTS TABLE (SELF-CONTAINED)
...
-- 4. CREATE STOCK MOVEMENTS TABLE (SELF-CONTAINED)
...
-- 5. CREATE STOCK ORDERS TABLE (SELF-CONTAINED)
...
-- 6. CREATE JOB PARTS TABLE (SELF-CONTAINED)
...
-- 7. CREATE INVENTORY ALERTS TABLE (SELF-CONTAINED)
...
-- 8. ENABLE ROW LEVEL SECURITY (SELF-CONTAINED)
...
-- 9. CREATE SEQUENCES (SELF-CONTAINED)
CREATE SEQUENCE IF NOT EXISTS movement_sequence START 1;
CREATE SEQUENCE IF NOT EXISTS order_sequence START 1;

-- 10. CREATE FUNCTIONS (SELF-CONTAINED)
...
-- 11. CREATE TRIGGERS (SELF-CONTAINED)
DO $$
BEGIN
...
-- 12. CREATE INDEXES FOR PERFORMANCE (SELF-CONTAINED)
...
-- 13. INSERT SAMPLE DATA (SELF-CONTAINED)
DO $$
DECLARE
    default_org_id UUID;
BEGIN
...
-- 14. CREATE VIEWS FOR REPORTING (SELF-CONTAINED)
...
-- 15. GRANT PERMISSIONS (SELF-CONTAINED)
...
-- 16. CREATE SIMPLIFIED RLS POLICIES (SELF-CONTAINED - NO external references)
...
-- 17. CREATE RLS POLICIES FOR VIEWS (SELF-CONTAINED)
DO $$
BEGIN
...
-- =====================================================
-- INTEGRATION COMPLETE (SELF-CONTAINED)
-- =====================================================
-- The Parts & Supplies system is now fully integrated with:
-- 1. Organizations table (created from scratch)
...
-- NOTE: This version is completely self-contained with no external dependencies
-- Creates organizations table from scratch
