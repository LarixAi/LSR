...
GRANT USAGE ON SEQUENCE public.daily_rest_id_seq TO authenticated;

-- Insert sample data (optional)
-- INSERT INTO public.daily_rest (driver_id, rest_date, rest_type, duration_hours, notes, organization_id)
-- SELECT 
--   p.id as driver_id,
--   CURRENT_DATE - INTERVAL '1 day' as rest_date,
--   'daily_rest' as rest_type,
--   24.0 as duration_hours,
--   'Sample rest day' as notes,
--   p.organization_id
