-- Create Defect Reports Table and Sample Data
-- This script creates the defect_reports table with comprehensive defect tracking
...
CREATE TRIGGER update_defect_reports_updated_at BEFORE UPDATE ON public.defect_reports
