-- Create Defect Reports Table and Sample Data (Simplified Version)
-- This script creates the defect_reports table without complex function triggers
...
-- Simple updated_at trigger (without complex function)
