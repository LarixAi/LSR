-- =====================================================
-- STEP 2: PARTS & SUPPLIES INTEGRATION (BEST PRACTICE VERSION)
-- =====================================================
...
-- 10. CREATE RLS POLICIES (BEST PRACTICE - No profiles.organization_id references)

-- 10.1 Parts Requests Policies - Use simple auth.uid() checks
...
-- NOTE: This version uses simplified RLS policies that don't reference profiles.organization_id
-- The organization-level filtering will be handled at the application level
-- This is a best practice for avoiding complex RLS recursion issues
