...
-- This fixes the infinite recursion error by using simpler, non-recursive policies
-- =============================================================================
...
-- Step 3: Create a function to safely check profile existence
...
-- Step 4: Create a function to safely get user organization
...
-- Step 5: Create a function to safely check if user is admin
