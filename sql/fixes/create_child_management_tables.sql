-- Create Child Management System Tables
-- This script creates all necessary tables for child profiles, communications, and parent features
...
-- 7. CHILD TRANSPORT STATUS TABLE
CREATE TABLE IF NOT EXISTS child_transport_status (
    id UUID DEFAULT gen_random_uuid() PRIMARY KEY,
    child_id UUID REFERENCES child_profiles(id) ON DELETE CASCADE,
