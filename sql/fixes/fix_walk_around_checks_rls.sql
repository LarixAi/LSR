...
-- =====================================================
-- CREATE DEFAULT WALK AROUND CHECK QUESTIONS
-- =====================================================
-- This creates a comprehensive set of 56 questions for daily pre-trip inspections
-- Based on DVSA standards and best practices
-- =====================================================

-- Function to create default walk around check questions
