-- =====================================================
-- SAFE COMPLIANCE TABLES MIGRATION
-- =====================================================

-- =====================================================
-- 1. CREATE DRIVER LICENSES TABLE (IF NOT EXISTS)
-- =====================================================
...
-- =====================================================
-- 2. CREATE COMPLIANCE ALERTS TABLE (IF NOT EXISTS)
-- =====================================================
...
-- =====================================================
-- 3. CREATE COMPLIANCE VIOLATIONS TABLE (IF NOT EXISTS)
-- =====================================================
...
-- =====================================================
-- 4. CREATE COMPLIANCE AUDIT LOGS TABLE (IF NOT EXISTS)
-- =====================================================
...
DROP POLICY IF EXISTS "Users can view driver licenses in their organization" ON public.driver_licenses;
DROP POLICY IF EXISTS "Users can insert driver licenses in their organization" ON public.driver_licenses;
DROP POLICY IF EXISTS "Users can update driver licenses in their organization" ON public.driver_licenses;
DROP POLICY IF EXISTS "Users can delete driver licenses in their organization" ON public.driver_licenses;

-- Compliance Alerts Policies
DROP POLICY IF EXISTS "Users can view compliance alerts in their organization" ON public.compliance_alerts;
...
DROP POLICY IF EXISTS "Users can view compliance audit logs in their organization" ON public.compliance_audit_logs;
DROP POLICY IF EXISTS "Users can insert compliance audit logs in their organization" ON public.compliance_audit_logs;
...
DROP TRIGGER IF EXISTS trigger_update_driver_licenses_updated_at ON public.driver_licenses;
...
DROP TRIGGER IF EXISTS trigger_update_compliance_alerts_updated_at ON public.compliance_alerts;
