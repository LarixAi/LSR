-- Sample Route Data for Parent Dashboard Testing (Robust Version)
-- This script inserts sample routes, vehicles, drivers, and assignments
...
-- Create sample vehicles (with only essential columns)
...
(
  (SELECT current_setting('app.org_id')::uuid),
  'Morning School Run',
  'Daily morning route to Lincoln Elementary School',
...
(
  ...
  'Daily afternoon route from Lincoln Elementary School',
  'Lincoln Elementary School',
...
SELECT vehicle_number, make, model, license_plate 
FROM vehicles 
