      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="relative max-w-6xl mx-auto">
          ...
          <div className="bg-gradient-to-br from-slate-800 to-slate-900 rounded-b-2xl p-8 shadow-2xl border border-slate-700">
            <div className="relative bg-white rounded-lg overflow-hidden shadow-inner min-h-[400px] flex items-center justify-center">
              ...
              <div className="w-full h-full bg-gradient-to-br from-blue-50 to-indigo-100 relative">
                ...
                <div className="absolute inset-0 bg-black/20 flex items-center justify-center">
                  <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 text-center shadow-xl max-w-md mx-4">
        ...
        <div className="mt-16 grid grid-cols-1 md:grid-cols-3 gap-8 animate-fade-in">
          ...
          <div className="text-center p-6 bg-slate-800/50 backdrop-blur-sm rounded-xl border border-slate-700">
            ...
            <h3 className="text-lg font-semibold text-white mb-2">Compliance Management</h3>
            <p className="text-blue-100 text-sm">
        ...
        <div className="text-center mt-16 animate-fade-in">
          <Button size="lg" className="bg-gradient-to-r from-green-500 to-teal-500 hover:from-green-600 hover:to-teal-600 text-white px-8 py-4 text-lg font-semibold shadow-xl hover:shadow-2xl transform hover:scale-105 transition-all duration-300">
