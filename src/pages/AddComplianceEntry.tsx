            ...
            <div className="flex items-center justify-between">
              <div className="flex items-center gap-4">
                ...
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <h1 className="text-3xl font-bold text-gray-900">Add Compliance Entry</h1>
          ...
          <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-8">
            ...
            <div className="bg-white rounded-lg shadow p-6">
              <div className="flex items-center justify-between mb-4">
                <h2 className="text-lg font-semibold text-gray-900">Compliance Entry Progress</h2>
                <Badge variant="outline" className="text-sm">
                  {activeTab === 'basic' && 'Step 1 of 5'}
                  {activeTab === 'details' && 'Step 2 of 5'}
                  {activeTab === 'vehicle' && 'Step 3 of 5'}
                  {activeTab === 'resolution' && 'Step 4 of 5'}
                  {activeTab === 'additional' && 'Step 5 of 5'}
                </Badge>
              </div>
              <div className="w-full bg-gray-200 rounded-full h-2">
                <div 
                  ...
                  style={{ 
                    width: activeTab === 'basic' ? '20%' : 
                           activeTab === 'details' ? '40%' : 
                           activeTab === 'vehicle' ? '60%' : 
                           activeTab === 'resolution' ? '80%' : '100%' 
                  }}
                ></div>
              </div>
            </div>
                ...
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">
                      Provide the essential details for this compliance entry
                    </p>
                  </CardHeader>
                      ...
                      <FormField
                        ...
                        render={({ field }) => (
                          <FormItem>
                            ...
                            <Select onValueChange={field.onChange} value={field.value || 'no_driver'}>
                              <FormControl>
                                <SelectTrigger>
              ...
              <TabsContent value="details" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">
                      Provide specific details about the compliance issue or inspection
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <TabsContent value="vehicle" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">
                      Provide detailed information about the vehicle condition and inspection
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <TabsContent value="resolution" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">
                      Document how the compliance issue was resolved and any follow-up actions
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <FormField
              ...
              <TabsContent value="additional" className="space-y-6">
                <Card>
                  <CardHeader>
                    ...
                    <p className="text-sm text-gray-600">
                      Provide any additional details, assignments, or notes
                    </p>
                  </CardHeader>
                  <CardContent className="space-y-6">
                    <FormField
...
export default AddComplianceEntry;
