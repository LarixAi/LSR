...
const AuthPage = () => {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col lg:flex-row mobile-form-container">
      {/* Left Column - Login Form */}
      <div className="flex-1 flex items-center justify-center px-4 sm:px-6 lg:px-8 py-6 sm:py-8 lg:py-12 overflow-y-auto safe-area-inset">
            ...
            <Tabs defaultValue="signin" className="w-full">
              ...
              <TabsContent value="signin" className="space-y-4 sm:space-y-6">
                <form onSubmit={handleSignIn} className="space-y-3 sm:space-y-4">
                  ...
                  <div className="space-y-2">
                    ...
                    <div className="relative">
                      ...
                      <Input
                        ...
                        className="pl-10 pr-10 h-12 sm:h-11 text-base"
                        required
                      />
                      <button
                        type="button"
                  ...
                  <Button 
                    type="submit" 
                    className="w-full h-12 sm:h-11 text-base font-medium bg-blue-600 hover:bg-blue-700" 
                    disabled={loading}
                  >
                ...
                <div className="grid grid-cols-2 gap-3">
                  <Button variant="outline" className="h-12 sm:h-11 text-sm">
