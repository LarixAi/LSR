...
const CreateWorkOrder = () => {
  ...
  const { createWorkOrder, isCreating } = useWorkOrders(selectedOrganizationId);
  ...
  const handleInputChange = (field: keyof CreateWorkOrderData, value: string | number) => {
  ...
  return (
    <DefaultViewPageLayout
      ...
      description="Report a new vehicle defect or maintenance issue"
          ...
          <CardContent className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
              <div>
                ...
                <Select value={formData.work_type} onValueChange={(value: any) => handleInputChange('work_type', value)}>
                  <SelectTrigger>
                    <SelectValue />
                  </SelectTrigger>
                  <SelectContent>
