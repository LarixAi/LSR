-- Fix mechanic signup by resolving all database issues
...
-- Create a security definer function to get user organization (prevents recursion)
...
BEGIN
    ...
    RAISE NOTICE 'SUCCESS: mechanic role exists in user_role enum and signup should work';
END $$;